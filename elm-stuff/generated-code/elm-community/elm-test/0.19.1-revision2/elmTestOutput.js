...
var $author$project$BattleTest$player = {
	currentCard: $elm$core$Maybe$Nothing,
	discard: _List_Nil,
	hand: _List_fromArray(
		[
			$author$project$Card$OneClubs(1)
		]),
	name: 'p1',
	position: 1
};
var $author$project$BattleTest$winner = {currentCard: $elm$core$Maybe$Nothing, discard: _List_Nil, hand: _List_Nil, name: 'winner', position: 1};
var $author$project$BattleTest$game = {
	cards: _List_Nil,
	discard: _List_Nil,
	playerTurn: 1,
	players: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2(0, $author$project$BattleTest$winner),
				_Utils_Tuple2(1, $author$project$BattleTest$player)
			]))
};
...
var $author$project$BattleTest$suite = A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					'should be only when one player have no cards',
					function (_v0) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just($author$project$BattleTest$winner),
							$author$project$Games$Battle$endGame($author$project$BattleTest$game));
					})
				]))
		]));
var $author$project$Test$Generated$Main1020448597$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['C:\\dev\\card-game\\tests\\BattleTest.elm']),
		processes: 16,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 259559771155391
	},
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'BattleTest',
				_List_fromArray(
					[$author$project$BattleTest$suite]))
			])));
_Platform_export({'Test':{'Generated':{'Main1020448597':{'init':$author$project$Test$Generated$Main1020448597$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "\\\\.\\pipe\\elm_test-23064-44";
